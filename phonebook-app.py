...
# Write a function named `init_todo_db` create phonebook table within enes_phonebook db, if it doesn't exist
def init_phonebook_db():
    phonebook_table = """
    CREATE TABLE IF NOT EXISTS enes_phonebook.phonebook(
